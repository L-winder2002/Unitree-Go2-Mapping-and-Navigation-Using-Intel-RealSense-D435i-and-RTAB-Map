    ...
    return [
        ...
        Node(
            ...
            remappings=[
                ...
                ("imu", ConditionalText(
        LaunchConfiguration('imu_topic').perform(context),
        'imu',
        IfCondition(PythonExpression(["'", LaunchConfiguration('imu_topic'), "' != ''"]))._predicate_func(context)
))],
                ...
                config_params,
                {
                    ...
                    "subscribe_odom_info": ConditionalBool(
                        ...
                        IfCondition(PythonExpression([
                            ...
                            LaunchConfiguration('visual_odometry'), "' == 'true'"
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('database_path',  default_value='~/Desktop/rtabmap.db',  description='Where is the map saved/loaded.'),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/robot_odom_fixed',  description='Odometry topic name.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
        ...
        DeclareLaunchArgument('publish_occupancy_grid', default_value='true', description='Publish 2D occupancy grid map'),
